...
The seventeen designers in `design-gods.md` are the principle layer of this skill. The eight references here are the working systems and canonical texts that show those principles in production. Together they answer a single question: when you are about to make a design decision, who has already made the same decision, well, and at scale?
