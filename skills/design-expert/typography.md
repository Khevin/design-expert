...
## Brand vs. product vs. editorial register for type

Every typography decision must answer a register question first: is this a brand surface, a product surface, or an editorial surface? They want different things, and conflating any two is one of the most common AI errors.
...
**Editorial surfaces** are the third register, and they want a **three-role pairing**: a body serif for narrative prose (transitional or modern — Caslon, Plantin, Source Serif, Crimson, Lyon, GT Sectra), a bold display sans for KPI numerals and chapter headers (80–130px, weight 600–700 — Inter Tight, Söhne, Neue Haas Grotesk, Söhne Breit), and a small label sans (mid-grey, 12–14px, often uppercase letterspaced — same family as the display sans at smaller weight, or a contrasting workhorse like Inter at 500). Three voices, one for each job. The body voice carries the writing, the display voice carries the structure, the label voice carries wayfinding. Mixing these — one font doing all three jobs — is the single biggest tell of a templated case study. The discipline is borrowed from Pentagram's project pages, Work & Co's client work, and the editorial-magazine tradition that both inherit. See `styles/editorial.md` for the canonical editorial register and `references/pentagram.md` for exemplars.

### Type for case studies and long-form

Editorial type loosens the product floors that `craft.md` § Density and the rest of this file impose. Three specific moves apply only when the register is editorial:

- **Extreme scale, by a factor of three to five.** Display sans-serif at 96–130px is right for chapter headers and KPI numerals; body serif at 18–20px is right for narrative prose. The ratio between display and body is 5–7×, an order of magnitude bigger than the 1.5–2× ratio that fits product surfaces. The contrast is the design — when the display is genuinely large, the chapter break reads as cinematic; when it is dashboard-sized, it reads as a section heading.
- **Strong weight contrast.** Display at 700 against body at 400 is the canonical contrast. Lighter display weights (300–500) against the same 400 body register as too-similar; heavier display weights (800–900) start to feel novelty. Pull quotes lift to 32–48px italic display serif (or italic body serif if the body face has a strong italic — Source Serif and Crimson both qualify); weight stays at 400 to keep the quote feeling like prose, not a heading.
- **Display fonts earn their place.** A workhorse sans (Inter Tight, Söhne, Neue Haas Grotesk) does the chapter-header job well; a true display face (Söhne Breit, GT Pressura, Migra, Editorial New) does it better when the brief permits a real display voice. Pick the display face deliberately; do not scale the body sans to display sizes and call it done. The single-font-scaled-up move is the AI default and produces the templated case study tell.

The discipline that makes the loosening work is restraint about *where* it is spent. Extreme scale belongs in chapter headers, KPI numerals, pull quotes, and the closing tribute — not in toast notifications, button labels, or empty-state illustrations. Save the budget for the moments that earn it. See `styles/editorial.md` § When to break the rules for the bolder/delight loosening rules in detail.
