...
The heuristics apply to both brand and product surfaces, but their weight differs. A brand surface — a campaign, a launch page, a marketing hero — can deliberately violate consistency and standards (heuristic 4) for memorability. A product surface — a dashboard, a settings panel, a bulk-edit table — cannot. Where the register changes the weight of a rule, this file says so explicitly.
